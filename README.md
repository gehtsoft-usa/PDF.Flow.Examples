...
2. The license allows to use this library during prototyping, development and testing of a commercial project. You should only purchase a commercial license only when the project goes alive. Please contact [Gehtsoft USA LLC](https://gehtsoftusa.com) to discuss the licensing. 
...
1. Visual Studio 2017 or above is installed.
   ...
   Please make sure that the way you are going to use Visual Studio is allowed by the community license. You may need
...
EXAMPLES
------------------------------------
PDFFlow library comes with a  [number of examples.](https://github.com/gehtsoft-usa/PDF.Flow.Examples/wiki//Examples) Each example is accompanied by a how-to article, which makes it a breeze to create your own documents fast. We add new real-world examples regularly, so check back the [examples page](https://github.com/gehtsoft-usa/PDF.Flow.Examples/wiki//Examples) or sign-up for our [email list](http://www.pdfflow.io/).
...
8. LogBook with Complex Tables
   ...
   The PDFFlow Library allows you to easily develop documents with a variety of complex tables without wasting time providing for complex layouts, measuring, multi-page spread-tables, etc. Make sure to review the how-to article to understand better how the library allows you to work with tables.
...
17. Tutorial (Book)
    ...
    a multi-page text document with mixed content. The document includes several sections and a repeating footer with automatic page numeration. Additionally, this example shows how to use images and how to work with tables. Read the article that describes this example in detail.

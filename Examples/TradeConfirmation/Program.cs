...
namespace TradeConfirmation
{
    class Program
    {
        ...
        {
            Parameters parameters = new Parameters(null, "TradeConfirmation.pdf");
            ...
            try
            {
                TradeConfirmationRunner.Run().Build(parameters.file);
            }
            catch (Exception e)
            {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine(
                "fullPathToOutFile - a path to the result file, 'TradeConfirmation.pdf' by default");
            Console.WriteLine(

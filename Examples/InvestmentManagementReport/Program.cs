...
namespace InvestmentManagementReport
{
    class Program
    {
        ...
        {
            Parameters parameters = new Parameters(null, "InvestmentManagementReport.pdf");
            ...
            try
            {
                InvestmentManagementReportRunner.Run().Build(parameters.file);
            }
            catch (Exception e)
            {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine(
                "fullPathToOutFile - a path to the result file, 'InvestmentManagementReport.pdf' by default");
            Console.WriteLine(

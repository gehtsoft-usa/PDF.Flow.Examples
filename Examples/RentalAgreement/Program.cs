...
namespace RentalAgreement
{
    class Program
    {
        ...
        {
            Parameters parameters = new Parameters(null, "RentalAgreement.pdf");
            ...
            try {
                RentalAgreementRunner.Run().Build(parameters.file);
            }
            catch (Exception e)
            {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine(
                "fullPathToOutFile - a path to the result file, 'RentalAgreement.pdf' by default");
            Console.WriteLine(

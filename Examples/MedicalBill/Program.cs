...
namespace MedicalBill
{
    class Program
    {
        ...
        {
            Parameters parameters = new Parameters(null, "MedicalBill.pdf");
            ...
            try
            {
                MedicalBillRunner.Run().Build(parameters.file);
            }
            catch (Exception e)
            {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine("Where: fullPathToOutFile - a path to the result file, 'MedicalBill.pdf' by default");

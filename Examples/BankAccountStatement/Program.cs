...
namespace BankAccountStatement
{
    class Program
    {
        ...
        {
            Parameters parameters = new Parameters(null, "BankAccountStatement.pdf");
            ...
            try {
                BankAccountStatementRunner.Run().Build(parameters.file);
            }
            catch (Exception e)
            {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine(
                "fullPathToOutFile - a path to the result file, 'BankAccountStatement.pdf' by default");
            Console.WriteLine(
